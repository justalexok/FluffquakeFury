...
FVector APointCollection::GetRandomNewGroundPoint(FVector PrevGroundPoint, float YawOverride)
{
	...
	USceneComponent* RandomPointSceneComponent = ArrayCopy[FMath::RandRange(0, ArrayCopy.Num() - 1)];
	
	return RandomPointSceneComponent->GetComponentLocation();
}
